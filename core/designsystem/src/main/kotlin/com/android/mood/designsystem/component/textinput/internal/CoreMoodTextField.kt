 ...
 */
@Composable
internal fun CoreMoodTextField(
    value: String,
    onValueChange: (String) -> Unit,
    modifier: Modifier = Modifier,
    colors: MoodTextFieldColors = MoodTextFieldDefaults.colors(),
 ...
 */
@Composable
internal fun CoreMoodTextFieldForTextFieldValue(
    value: TextFieldValue,
    ...
    BasicTextField(
        ...
        visualTransformation = visualTransformation,
        interactionSource = interactionSource,
        cursorBrush = MoodTextFieldDefaults.cursor(),
        onTextLayout = onTextLayout,
        decorationBox = { innerTextField ->
            MoodTextFieldDecorationBox(
