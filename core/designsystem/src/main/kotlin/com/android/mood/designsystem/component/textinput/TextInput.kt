package com.android.mood.designsystem.component.textinput
...
import com.android.mood.designsystem.component.textinput.internal.CoreMoodTextField
import com.android.mood.designsystem.component.textinput.internal.CoreMoodTextFieldForTextFieldValue
import com.android.mood.designsystem.component.textinput.internal.MoodTextFieldDefaults
...
fun TextInput(
    ...
    textStyle: TextStyle = MoodTextFieldDefaults.TextStyle,
    placeholder: String? = null,
    label: String? = null,
    isNecessary: Boolean = false,
    helperText: String? = null,
    isHelperTextVisible: Boolean = false,
    state: MoodTextFieldState = MoodTextFieldState.ENABLED,
    ...
    CoreMoodTextField(
        ...
        innerTrailingContent = if (shouldRemoveIconVisible) {
            {
                MoodTextFieldDefaults.TrailingRemoveIcon(onClick = onRemoveIconClick)
            }
        } else {
...
fun TextInput(
    ...
    CoreMoodTextFieldForTextFieldValue(
        value = value,
        onValueChange = onValueChange,
        modifier = modifier,
        textStyle = textStyle,
