...
class Headline {
    val headline1 = TextStyleSet(
        ...
        regular = pretendardMedium(size = 56, lineHeight = 72, letterSpacing = (-1.78F)),
    )
    val headline2 = TextStyleSet(
        ...
        regular = pretendardMedium(size = 44, lineHeight = 57, letterSpacing = (-1.32F)),
    )
    val headline3 = TextStyleSet(
        ...
        regular = pretendardMedium(size = 40, lineHeight = 52, letterSpacing = (-1.12F)),
    )
    val headline4 = TextStyleSet(
        ...
        regular = pretendardMedium(size = 36, lineHeight = 48, letterSpacing = (-0.97F)),
    )
    val headline6 = TextStyleSet(
        ...
        regular = pretendardMedium(size = 28, lineHeight = 38, letterSpacing = (-0.66F))
    )
